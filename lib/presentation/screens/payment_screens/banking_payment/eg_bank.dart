...
class EGBankDeposit extends StatelessWidget {
  const EGBankDeposit({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Proceed to the nearest EG Bank branch and make a deposit with the following details, then confirm transfer on our app',style: TextStyle(fontSize: 16,color: Colors.grey[700]),),
                      ),
                      //########################################
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child: Text('EG Bank',style: TextStyle(fontSize: 16,color: Colors.grey[700]),)),
                      ),
                      //Divider(height: 20,),
                      //########################################
                      Padding(
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child: Text('01234567890344651',style: TextStyle(fontSize: 16,color: Colors.grey[700]),)),
                      ),
                      //Divider(height: 20,),
                      //#######################################
                      Padding(
